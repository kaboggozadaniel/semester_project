...
This is a semester project. For improvements or modifications:
...
This project is developed as part of an academic course. Please check with the course instructor for usage permissions.

## Acknowledgments

- Built using FastAPI, Scikit-learn, and other open-source libraries
- Dataset sources: Resume and job data for educational purposes
- Course: 92400566001_SEM_PROJECT</content>
<parameter name="filePath">c:\Users\Kimlein\Desktop\92400566001_SEM_PROJECT\semester_project\README.md